		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑警察信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑警察信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">警察信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>警员编号</label>
										<input id="jingyuanbianhao" name="jingyuanbianhao" class="form-control" placeholder="警员编号">
									</div>
									<div class="form-group col-md-6">
										<label>警员名字</label>
										<input id="jingyuanmingzi" name="jingyuanmingzi" class="form-control" placeholder="警员名字">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jingchaxinxi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("jingchaxinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jingchaxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#jingyuanbianhao").val(ruleForm.jingyuanbianhao);	
			$("#jingyuanmingzi").val(ruleForm.jingyuanmingzi);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jingyuanbianhao != null && res.data.jingyuanbianhao != ''){

					$("#jingyuanbianhao").val(res.data.jingyuanbianhao);
					}
					if(res.data != null && res.data != '' && res.data.jingyuanmingzi != null && res.data.jingyuanmingzi != ''){

					$("#jingyuanmingzi").val(res.data.jingyuanmingzi);
					}
